...
\documentclass[tikz,margin=0pt, convert={density=300,size=2048x2048,outfile=Roller-Smith_90702_J1_Amperometer_A1.png}]{standalone}
...
\newcommand\externalRadius{1.6}
\newcommand\graduateThick{0.14}
	...
	{\ocrfamily
		\begin{tikzpicture}
			...
			\foreach \a in {-40,0,...,40}
					...
					($(c1) + (-\a + 90 :\externalRadius-\graduateThick)$) -- ($(c1)+(-\a + 90:\externalRadius + 0.05)$);
		\end{tikzpicture}
	}
\end{document}