...
var pilot_assistant = func {
    ...
    if (landig_departure_status_id == 1 and landig_departure_status_id < 10 and airport_select == nil) {
        setprop("fdm/jsbsim/systems/autopilot/gui/airport_landing_status","No airport for landing");
            ...
            and rwy_select != nil 
            and size(rwy_select) == 2 
            and rwy_coord_start != nil) {
        ...
        if (landig_departure_status_id == 2.0) {
            ...
            if ((math.abs(slope - holding_point_slope_avg)) < 1 and (getprop("fdm/jsbsim/systems/autopilot/speed-cas-on-air") <= 210.0) and isHolding_reducing_terminated == 0) {
            ...
            if (isHolding_reducing_terminated == 0 or isHolding_reducing_delta >= 0) {
                ...
                setprop("fdm/jsbsim/systems/autopilot/gui/pid-ku",0.6);
                setprop("fdm/jsbsim/systems/autopilot/gui/pid-tu",4.0);
            }
            print("Landing 2.1 >"
            ...
            if (((airplane.distance_to(rwy_coord_start) * 0.000621371) < 0.8 and altitude_agl_ft < 250.0) == 0) {
                ...
                if (speed_cas > (cas_max + 5.0) or (runway_to_airplane_dist_direct < 8.0)) {
                    if ((math.abs(getprop("fdm/jsbsim/systems/autopilot/true-heading-turn-direction-versus-slope-sw-lag-deg")) < 2.0) and (landing_slope < 9.0)) {
                        setprop("fdm/jsbsim/systems/airbrake/manual-cmd",1.0);
                    } else {
                        setprop("fdm/jsbsim/systems/airbrake/manual-cmd",0.0);
                    }
    ...
    if (landig_departure_status_id >= 10.0 and landig_departure_status_id < 11.0) {
        ...
        if (landig_departure_status_id == 10.0) {
            ...
            print("Departure 10.2 > Motor acceleration phase N2: ",getprop("/jsbsim/propulsion/engine[0]/n2"));
...
setlistener("fdm/jsbsim/systems/autopilot/gui/take-off-activate", func {
    if (getprop("fdm/jsbsim/systems/autopilot/gui/take-off-activate") == 1) {
        ...
        } else if (landig_departure_status_id == 10 and airport_select != nil and rwy_select != nil) {
...
setlistener("fdm/jsbsim/systems/autopilot/gui/landing-holding-point-dist-nm", func {
    ...
    if (holding_point_slope_imposed > 6.0) {
        elev = dist * 0.105 * 6076.12; # tan(5.0) deg
...
setlistener("fdm/jsbsim/systems/autopilot/gui/landing-holding-point-h-ft", func {
    ...
    holding_point_slope_imposed = math.atan((elev / 6076.12) / dist)*R2D;
    if (holding_point_slope_imposed > 6.0) {
        dist = (elev / 6076.12) * 9.514; # tan(84.0) deg
