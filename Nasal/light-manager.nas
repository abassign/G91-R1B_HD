...
var light_manager = {
	...
	update: func {
		...
		if (als_on == 1 and alt_agl < 100.0) {
			...
			ll1 = getprop("fdm/jsbsim/systems/lightning/landing-light/on");
			ll2 = getprop("fdm/jsbsim/systems/lightning/taxiing-light/on");;
			ll3 = 0;
			nav = 1;
			...
			if (ll1 > 0.01) {
                size_norm = getprop("fdm/jsbsim/systems/lightning/landing-light/intensity-norm");
				me.light1_ypos =  0.0;
				me.light1_setSize(16 * size_norm);
				me.light1_on();
			} else {
				me.light1_off();
			} 
			...
			if (ll2 > 0.01) {
                size_norm = getprop("fdm/jsbsim/systems/lightning/taxiing-light/intensity-norm");
				me.light2_ypos =  0.0;
				me.light2_setSize(5 * size_norm);
				me.light2_on();
			} else {
				me.light2_off();
			}
