...
var timer_re_emit_green_red_gauges = maketimer(0.5, func() {
    ...
    var pl_emission = 0.0;
    pl_emission = -29.7 * math.pow(ambientBlueLight,3) + 6.7 * math.pow(ambientBlueLight,2) - 1.29 * ambientBlueLight + 0.97;
    
    # Use for controlled light for example cabin advisor lights
    setprop("sim/G91/light/lg_base",pl_emission * 0.2);
    ...
    setprop("sim/G91/re_emit/gauge_red_light",pl_emission);
    setprop("sim/G91/re_emit/gauge_spot_internal_red_light",pl_emission * 0.05);
