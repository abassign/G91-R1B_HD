...
var prop = props.globals.initNode("sim/G91/re_emit/gauge_red_15_phosphorescent_light", 0, "DOUBLE");
var prop = props.globals.initNode("sim/G91/re_emit/gauge_red_20_phosphorescent_light", 0, "DOUBLE");
var prop = props.globals.initNode("sim/G91/re_emit/gauge_red_25_phosphorescent_light", 0, "DOUBLE");
...
var timer_re_emit_green_red_gauges = maketimer(0.5, func() {
    ...
    setprop("sim/G91/re_emit/gauge_red_10_phosphorescent_light",(red_emer_instrument * 0.1 * (1 - pl_phosphorescent_emission) + pl_phosphorescent_emission * 0.9));
    setprop("sim/G91/re_emit/gauge_red_15_phosphorescent_light",(red_emer_instrument * 0.15 * (1 - pl_phosphorescent_emission) + pl_phosphorescent_emission * 0.85));
    ...
    setprop("sim/G91/re_emit/gauge_red_25_phosphorescent_light",(red_emer_instrument * 0.25 * (1 - pl_phosphorescent_emission) + pl_phosphorescent_emission * 0.75));
    ...
    setprop("sim/G91/re_emit/gauge_console_lamp_3200_console_red_50",(light_red_console * (1 - light_red_console) * 0.5 + pl_phosphorescent_emission * 0.5));
    setprop("sim/G91/re_emit/gauge_console_lamp_3200_console_green_50",(light_red_console * (1 - light_red_console) * 0.3 + pl_phosphorescent_emission * 0.4));
    setprop("sim/G91/re_emit/gauge_console_lamp_3200_console_blue_50",(light_red_console * (1 - light_red_console) * 0.2 + pl_phosphorescent_emission * 0.2));
