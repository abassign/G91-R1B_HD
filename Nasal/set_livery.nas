            ...
            if (num_players > 0) {
                ...
                if (target_module_id == -1) {
                    ...
                    foreach(var tmId; keys(targets_module_id)) {
                        ...
                        if (id != idNew) {
                            print("set_livery.nas livery_multiplayer timer update id: ",idNew, " is different old id: ",id, " list dim: ",num_players);
                ...
                if (insert_targets_module_id == 1 and target_module_id >= 0) {
                    ...
                    targets_module_id[target_module_id]["id"] = node.getNode("sim/G91/liveries/active/id").getValue();
